...
/**
 * Merriam-Webster Advanced Learner's Dictionary for Pronunciation and Etymology
 * Converted to Kotlin as part of Phase 2 data model migration
 */
class Maldpe(private val mContext: Context) : IDictionary {
    private val roomDb: MaldpeDatabase = MaldpeDatabase.getInstance(mContext)
    private val dao: MaldpeDao = roomDb.maldpeDao()

    override fun getDictionaryKey(): String = "maldpe"
    ...
    companion object {
        ...
        private val DICT_NAME_RES_ID = R.string.dict_name_merriam_webster
        private val DICT_DESC_RES_ID = R.string.dict_desc_merriam_webster
