...
/**
 * Cambridge Dictionary of English Pronunciation for EFL (4th Edition)
 * Converted to Kotlin as part of Phase 2 data model migration
 */
class Cdepe4(private val mContext: Context) : IDictionary {
    private val roomDb: Cdepe4Database = Cdepe4Database.getInstance(mContext)
    private val dao: Cdepe4Dao = roomDb.cdepe4Dao()

    override fun getDictionaryKey(): String = "cdepe4"
    ...
    companion object {
        private const val DATABASE_NAME = "cdepe4.db"
        ...
        private val DICT_NAME_RES_ID = R.string.dict_name_cambridge
        private val DICT_DESC_RES_ID = R.string.dict_desc_cambridge
