...
public class LauncherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewOpenAIConfig.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LauncherActivity.this, com.lmyby.ankihelper.ui.ai.AIConfigActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void openSettingsPage() {
        Intent intent = new Intent(this, com.lmyby.ankihelper.ui.settings.SettingsActivity.class);
        startActivity(intent);
    }
