...
enum class AppTheme(
    ...
    DEFAULT("default", R.style.Theme_AnkiQuicker, R.style.Transparent),
    PINK("pink", R.style.Theme_AnkiQuickerPink, R.style.TransparentPink),
    EINK("eink", R.style.Theme_AnkiQuickerEink, R.style.Transparent),
    DARK("dark", R.style.Theme_AnkiQuickerDark, R.style.TransparentDark);
